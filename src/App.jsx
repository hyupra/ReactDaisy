...
function App() {
  ...
  <div className="flex-1">
    <a className="btn btn-ghost normal-case text-xl">Wahyu</a>
  </div>
  ...
  <div className="hero-content text-center">
    <div className="max-w-md">
      ...
      <p className="py-6">I am a programming enthusiast, at this stage I am still in the process of learning and deepening my skills using ReactJS.</p>
      <button className="btn btn-primary">My Portofolio</button>
    </div>
  </div>
</div>
    <div>
    <div className="flex space-x-4">
      {/* Card 1 */}
      <div className="card w-96 bg-base-10 shadow-xl pt-9">
        <figure><img src={sepatu} className='Card-Image' alt="Sepatu" /></figure>
        <div className="card-body">
  ...
  <img src={sepatu} className='Card-Image' alt="Sepatu" />
    <div>
...
<footer className="footer footer-center p-10 bg-primary text-primary-content">
  <aside>
    ...
    <p>Copyright © Wahyu Prayoga 2023 - All right reserved</p>
  </aside> 
  <nav>
